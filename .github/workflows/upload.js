...
module.exports = async ({ github, context }) => {
  ...
  const compiled_extensions = [
    {
      name: "vector0.so",
      path: "sqlite-vector-ubuntu/vector0.so",
      asset_name: `sqlite-vector-${VERSION}-ubuntu-x86_64.tar.gz`,
    },
    {
      name: "vector0.dylib",
      path: "sqlite-vector-macos/vector0.dylib",
      asset_name: `sqlite-vector-${VERSION}-macos-x86_64.tar.gz`,
    },
  ];
